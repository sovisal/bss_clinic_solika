...
Route::middleware(['auth'])->prefix('patient')->name('patient.')->group(function () {
	...
	Route::put('/{patient}/restore', [PatientController::class, 'restore'])->name('restore')->middleware('can:RestorePatient');
	Route::delete('/{patient}/force_delete', [PatientController::class, 'force_delete'])->name('force_delete')->middleware('can:ForceDeletePatient');
