...
Route::prefix('echography')->middleware(['auth'])->name('para_clinic.echography.')->controller(EchographyController::class)->group(function () {
    ...
    Route::put('/{ecgType}/restore', 'restore')->name('restore')->middleware('can:RestoreEchography');
    Route::delete('/{ecgType}/force_delete', 'force_delete')->name('force_delete')->middleware('can:ForceDeleteEchography');
