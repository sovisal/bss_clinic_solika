<x-app-layout>
    <x-slot name="header">
        <x-form.button href="{!! route('setting.labor-type.index') !!}" color="danger" icon="bx bx-left-arrow-alt"
            label="Back" />
    </x-slot>
                ...
                <tr>
                    ...
                    <td>
                        <x-bss-form.select name="other" data-no_search="true">
                            @foreach (['OUT_RANGE_COLOR_RED' => 'NORMAL','VALUE_POSITIVE_NEGATIVE' => 'POSITIVE / NEGATIVE','VALUE_160_320' => '160 /
                            320'] as $k => $v)
