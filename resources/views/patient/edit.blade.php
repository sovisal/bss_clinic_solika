        ...
        <x-card bodyClass="pb-0">
            ...
            <table class="table-form striped">
                ...
                <tr>
                    ...
                    <td>
                        <x-bss-form.input name="date_of_birth" class="date-picker" :value="old('date_of_birth', $patient->date_of_birth)"
                            hasIcon="right" icon="bx bx-calendar" />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <x-bss-form.input name="registered_at" class="date-time-picker" hasIcon="right" icon="bx bx-calendar"
                ...
                <tr>
                    ...
                    <td>
                        <x-bss-form.select name="marital_status" data-no_search="true">
                            ...
                            <option value="{{ $id }}" {{ (old('nationality', $patient->marital_status) == $id) ? 'selected' : '' }}>{{ $data }}
                            </option>
                            @endforeach
                        </x-bss-form.select>
                    </td>
