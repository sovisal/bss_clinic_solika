@if ($invoice_selection && ($invoice_selection['echography'] || $invoice_selection['ecg'] || $invoice_selection['xray'] || $invoice_selection['laboratory'] || $invoice_selection['prescription']))
