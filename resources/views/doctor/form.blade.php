<table class="table-form striped">
    ...
    <x-bss-form.input-row name="name_kh" :value="old('name', @$doctor->name_kh)" required autofocus label="Name in Khmer" />
    <x-bss-form.input-row name="name_en" :value="old('name', @$doctor->name_en)" required label="Name in English" />
    <x-bss-form.input-row name="id_card_no" :value="old('name', @$doctor->id_card_no)" label="Identity Card Number" />
