<x-app-layout>
    ...
    <form action="{{ route('user.ability.store') }}" method="POST" autocomplete="off">
        @csrf
        <x-card>
            <x-form.input name="module" required label="{!! __('form.ability.module') !!} <small class='required'>*</small>" />
            ...
            <x-card :foot="false" class="border mb-0 card-hover">
                ...
                <div class="ability-list">
                    ...
                    <div class="ability-option {{ ((old('hidden_crud')[$c]=='true')? 'ability-option-crud' : '') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <x-form.select name="category[]" data-no_search="true" required
                                    label="{!! __('form.ability.category') !!} <small class='required'>*</small>">
