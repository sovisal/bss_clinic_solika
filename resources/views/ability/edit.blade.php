<x-app-layout>
    ...
    <form action="{{ route('user.ability.update', $ability_module) }}" method="POST" autocomplete="off">
        ...
        @csrf
        <x-card>
            <x-form.input name="module" value="{{ $ability_module->module }}" required
                label="{!! __('form.ability.module') !!} <small class='required'>*</small>" />

            <x-card :foot="false" class="border mb-0 card-hover">
                <x-slot name="header">
                ...
                <div class="ability-list">
                    ...
                    <div class="ability-option">
                        <div class="row">
                            <div class="col-sm-3">
                                <x-form.select name="category[]" :select2="false" required
                                    label="{!! __('form.ability.category') !!} <small class='required'>*</small>">
                            ...
                            <div class="col-sm-4">
                                <x-form.input name="name[]" value="{{ old('name')[$c] }}" required
                                    label="{!! __('form.name') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-4">
                                <x-form.input name="label[]" value="{{ old('label')[$c] }}" required
                                    label="{!! __('form.label') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-1">
                                <x-form.field class="text-center tw-pt-3">
                                    <a href="javascript:void(0)" class="text-danger d-block mt-2 remove-ability-option"><i
                    ...
                    <div class="ability-option">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <x-form.select name="old_category[]" :select2="false" required
                                    label="{!! __('form.ability.category') !!} <small class='required'>*</small>">
                            ...
                            <div class="col-sm-4">
                                <x-form.input name="old_name[]" value="{{ old('old_name')[$oc] }}" required
                                    label="{!! __('form.name') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-4">
                                <x-form.input name="old_label[]" value="{{ old('old_label')[$oc] }}" required
                                    label="{!! __('form.label') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-1">
                    ...
                    <div class="ability-option">
                        ...
                        <input type="hidden" name="old_in_used[]"
                            value="{{ (($ability->users->count()==0 && $ability->roles->count()==0)? 'true' : '') }}">
                        <div class="row">
                            <div class="col-sm-3">
                                <x-form.select name="old_category[]" :select2="false" required
                                    label="{!! __('form.ability.category') !!} <small class='required'>*</small>">
                            ...
                            <div class="col-sm-4">
                                <x-form.input name="old_name[]" value="{{ $ability->name }}" required
                                    label="{!! __('form.name') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-4">
                                <x-form.input name="old_label[]" value="{{ $ability->label }}" required
                                    label="{!! __('form.label') !!} <small class='required'>*</small>" />
                            </div>
                            <div class="col-sm-1">
