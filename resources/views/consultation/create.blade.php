                ...
                <div class="tab-pane" id="examination" aria-labelledby="examination-tab" role="tabpanel">
                    <table class="table-form striped">
                        ...
                        <tr>
                            <td class="text-right">Left</td>
                            <td>
                                <x-bss-form.input name='examination_hand_left' />
                            </td>
                            <td class="text-right">Right</td>
                            <td>
                                <x-bss-form.input name='examination_hand_right' />
                            </td>
                        </tr>
                        <tr>
                            <td class="text-right">Body</td>
                            <td>
                                <x-bss-form.input name='examination_body' />
                            </td>
                            <td class="text-right">Other</td>
                            <td>
                                <x-bss-form.textarea name="examination_hand_other"></x-bss-form.textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="text-right">Left</td>
                            <td>
                                <x-bss-form.input name='examination_foot_left' />
                            </td>
                            <td class="text-right">Right</td>
                            <td>
                                <x-bss-form.input name='examination_foot_right' />
                            </td>
                        </tr>
                        <tr>
                            <td class="text-right">Other</td>
                            <td>
                                <x-bss-form.textarea name="examination_foot_other"></x-bss-form.textarea>
                            </td>
                            <td colspan="2"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <x-bss-form.select name="evaluation_category">
                                    ...
                                    <option value="{{ $id }}" {{ ((old('evaluation_category')==$id)? 'selected' : '' ) }}>{{ $evaluation_category }}
                                    </option>
                                    @endforeach
                                </x-bss-form.select>
                            </td>
                    ...
                    <table class="table-form striped">
                        ...
                        <tr>
                            <td width="30%">
                                <div class="d-flex justify-content-between">
                                    <b>Prescription</b>
                                    <x-form.button class="btn-treatment-toggle" data-type="prescription" color="secondary" icon="bx bx-plus"
                                        label="" />
                                </div>
                            </td>
                            <td></td>
